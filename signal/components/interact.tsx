...
export function Slot({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "flex min-h-16 min-w-20 flex-col items-center justify-center gap-1 rounded-2xl border border-dashed px-3 py-2 transition",
